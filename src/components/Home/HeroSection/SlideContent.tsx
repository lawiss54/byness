    ...
    >
      <div className="text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <m.h1 
          ...
          className="text-4xl sm:text-5xl lg:text-7xl font-heading font-heading-bold text-shadow text-shadow-y-2 text-shadow-x-3 text-shadow-blur-[13px] text-shadow-md text-shadow-black/40 text-brand-darkGreen-900 mb-6 leading-tight"
        >
          {slide?.title}
        </m.h1>
