...
import { OrdersGrid } from '@/components/Dashboard/Orders/OrdersGrid';
import { OrdersPagination } from '@/components/Dashboard/Orders/OrdersPagination';
import { OrdersModals } from '@/components/Dashboard/Orders/OrdersModals';
...
export default function OrdersSection({ initialOrders }: OrdersSectionProps) {
  const {
    // Data
    orders,
    filteredOrders,
    ...
    setShowOrderEdit,
    setCurrentOrder
  } = useOrdersManagement({ initialOrders });
